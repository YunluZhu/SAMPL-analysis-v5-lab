...
folder_name = f'BT2_angvel_corr_timeSeries'
...
g.set(xlim=(-200,200))
plt.savefig(fig_dir+f"/pre_bout_angle_by dir and cond.pdf",format='PDF')
...
g.set(xlim=(-200,200))
plt.savefig(fig_dir+f"/pre_bout_angle_by cond.pdf",format='PDF')
# %%
