...
# tsne = TSNE(n_components=2, verbose=1, perplexity=50,n_iter=1000,early_exaggeration=12,learning_rate=max(10000/12/4,200))
    # test
tsne = TSNE(n_components=2, verbose=1, perplexity=45500/100,n_iter=800,early_exaggeration=15,learning_rate=max(45500/15/4,200))
...
# time_start = time.time()
# tsne = TSNE(n_components=3, verbose=0, perplexity=50, n_iter=2000)
# tsne_pca_results = tsne.fit_transform(pca_result_for_tsne)
# print('t-SNE done! Time elapsed: {} seconds'.format(time.time()-time_start))
