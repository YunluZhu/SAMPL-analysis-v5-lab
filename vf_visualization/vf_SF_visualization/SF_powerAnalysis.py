...
def power_analysis(high_bout_data, feature_tuple):
    ...
    sib_bout = dir_high_bout.loc[dir_high_bout.condition == 'sibs']
    ...
    tau_data = dir_high_bout.loc[(dir_high_bout.clutch_id == max_sib_clutch) & (dir_high_bout.condition == 'tau')]
...
# %%
# add IEI mean data
sibs_data = high_bout_IEI.loc[high_bout_IEI.condition=='sibs','propBoutIEI']
