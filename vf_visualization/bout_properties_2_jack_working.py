...
fig_dir = "/Users/yunluzhu/Documents/Lab2/Data/VF_ana/Figures/ST_tmp_plots/"
plotKDE = 1
plotMeanData = 1
# %%
# CONSTANTS
...
negPitch_data = all_data_cond.loc[all_data_cond['pre_pitch']<3,:]
posPitch_data = all_data_cond.loc[all_data_cond['pre_pitch']>3,:]

tmp_data = all_data_cond.loc[all_data_cond['heading']<-10,:]
...
plt.show()
print(f'{df_mean.columns[i]} Sibs v.s. Tau: paired t-test p-value = \n{ttest_p}')
