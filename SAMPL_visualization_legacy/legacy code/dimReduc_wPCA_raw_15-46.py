...
folder_name = f'{pick_data}_dimReduc_raw_{DayNight_select}'
    ...
    for subpath, subdir_list, subfile_list in os.walk(folder):
        ...
        if subdir_list:
            ...
            # extract features
                ...
                atk_ang = peak_angles_day['traj'] - peak_angles_day['propBoutAligned_pitch']
                ...
                bout_features = pd.DataFrame(data={'atk_ang':atk_ang.values, 
                                             ...
                                             'heading': peak_angles_day['propBoutAligned_instHeading'], 
             ...
             # raw bout data    
                ...
                re_format = pd.concat([re_format, 
                                    ...
                                    #    angles.loc[angles['idx']==30].reset_index().propBoutAligned_instHeading,
...
hue_col = 'accel_ang' # change the hue to plot
...
#     sns.pointplot(x='clusters',y=feature, hue='cond1',data=res_toplt,
