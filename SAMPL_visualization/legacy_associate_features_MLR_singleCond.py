...
# feature_list = ['exp_condition' ,'expNum_cond'] # categorical 
...
model = Lm("ydispl_swim ~  pitch_peak + vel_peak + yvel_peak + traj_peak + rot_l_decel + rot_full_accel", data=df_all)
model.fit()
...
feature_of_interest = 'speed_bins'
hue_feature = 'ztime'
g = sns.catplot(data = classifier_res,
                kind = 'point',
                hue = hue_feature,
