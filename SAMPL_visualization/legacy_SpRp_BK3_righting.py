...
pick_data = 'tau_rfp' # name of your dataset to plot as defined in function get_data_dir()
##### Parameters to change #####
...
folder_name = f'SpRp_BK3_righting_scatterPlt'
...
binned_rotation = 'rot_full_decel'
