...
pitch_bin_average = all_feature_UD.groupby(['cond1','speed_bins','initial_bins'])['pitch_initial'].mean().reset_index()
pitch_bin_average.columns = ['cond1','speed_bins','initial_bins','mean_pitch']
pitch_bin_average = pitch_bin_average.sort_values(by=['cond1','speed_bins'])
