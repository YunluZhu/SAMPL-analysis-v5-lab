...
epoch_data_all_down_sampled = epoch_data_all.iloc[::5,:].copy()
...
while epoch_number != 'n':
    ...
    data_toplt = epoch_data_all_down_sampled.loc[(epoch_data_all_down_sampled['exp_num']==toplt['exp_num']) & (epoch_data_all_down_sampled['epochNum']==round_half_up(toplt['epoch_num'])), :]
