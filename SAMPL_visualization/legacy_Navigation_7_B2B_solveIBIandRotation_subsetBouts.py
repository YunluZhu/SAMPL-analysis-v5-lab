...
folder_name = f'Navi7_B2B_subset_z{which_ztime}'
...
sns.displot(
    ...
    levels=8,
    facet_kws={
        'xlim': np.percentile(longIBI_trajDevDN[xval].dropna(),[.2, 99.5]),
        'ylim': np.percentile(longIBI_trajDevDN[yval].dropna(),[.5, 99.8])
    }
)
