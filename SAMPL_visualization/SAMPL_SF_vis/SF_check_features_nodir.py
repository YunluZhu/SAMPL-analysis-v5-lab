...
root, FRAME_RATE = "/Volumes/LabData/VF_data_in_use/tmp_single_fish_for_manuscript", 166
...
average_bouts_24h = all_mean_data['aligned_bouts']/2
print(f"{average_bouts_24h.mean()} ± {average_bouts_24h.std()}")
