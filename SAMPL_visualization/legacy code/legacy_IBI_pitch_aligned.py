...
for condition_idx, folder in enumerate(folder_paths):
    ...
    for subpath, subdir_list, subfile_list in os.walk(folder):
        ...
        if subdir_list:
            ...
            jack_y_all = pd.concat([jack_y_all, jack_y.assign(age=cond1, cond1=cond1)], axis=0, ignore_index=True)
            ...
            ang_std_all = pd.concat([ang_std_all, ang_std.assign(age=cond1, cond1=cond1)], axis=0, ignore_index=True)
