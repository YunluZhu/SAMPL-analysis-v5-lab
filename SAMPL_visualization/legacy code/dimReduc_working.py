...
ALIGNED_BOUT_RANGE = range(20,40)
...
get_clusters = DBSCAN(eps=1.5, min_samples=20).fit_predict(tsne_pca_results)
...
all_size
# %% add train test split or just randomly pick same amount of data 
