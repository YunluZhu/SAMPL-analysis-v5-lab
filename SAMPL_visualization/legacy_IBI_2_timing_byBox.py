...
pick_data = 'creTau9' # name of your dataset to plot as defined in function get_data_dir()
...
RESAMPLE = 800 # same resample number applied to day and night
##### Parameters to change #####
...
if RESAMPLE !=0:
    ...
    IBI_sampled = IBI_sampled.sort_values(by='expBoxNum').reset_index()
...
resampled_coef.columns = ['sensitivity','x intersect','y intersect','cond0','cond1','resample num']
