...
def grab_fish_angle(analyzed, fish_length,sample_rate):
    ...
    POST_BOUT_BUF = math.ceil(0.1 * SAMPLE_RATE)  # 100 ms
    PRE_BOUT_BUF = math.ceil(0.1 * SAMPLE_RATE)  # 100 ms
    BOUT_WINDOW_HALF = math.ceil(0.3 * SAMPLE_RATE)  # 300 ms
    # SM_WINDOW = math.ceil((3/40) * SAMPLE_RATE)  # 
    SM_WINDOW = 3
    ...
    BOUT_LONG_TAIL = SAMPLE_RATE  # align prop bouts with longer duration 
    ...
    # this heading notes the direction fish is moving towards, in a range -90:90 deg
    ...
    bout_res2 = bout_res2.assign(
        ...
        propBout_maxSpd = bout_aligned['peakSpeed'], 
