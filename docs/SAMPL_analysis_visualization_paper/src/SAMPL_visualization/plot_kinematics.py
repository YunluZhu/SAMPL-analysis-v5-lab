...
# %%
def plot_kinematics(root, **kwargs):
    """plot kinematics. 
    ...
    output_par = bout_kinematics.iloc[:,[0,1,2]]
    if if_multiple_repeats:
        table_filename = os.path.join(fig_dir,f"kinematics mean values across repeats.csv")
    else:
