...
For the current version (v4.1), users need to run `vf_analysis/vf_analysis_....py` to analyze .dlm files. Then, run individual visualization script under `vf_visualization/` to make figures. See below for detailed instructions.
