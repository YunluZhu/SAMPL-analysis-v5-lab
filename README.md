...
`docs` contains a copy of catalog files generated after running `.../SAMPL_analysis/SAMPL_analysis_by_folder_v4.py`, the conda env file, and expected number of swim bouts captured over 24 hrs per box in constant dark.

`docs/SAMPL_analysis_paper` contains code for the behavior mechod manuscript that should work out of the box.
...
1. Run `SAMPL_analysis/SAMPL_analysis_....py`.
