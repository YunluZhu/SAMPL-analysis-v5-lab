...
# %%
# CONSTANTS
# root = "/Volumes/LabData/SAMPL_Paige/for_ana"
HEADING_LIM = 90
    ...
    for condition_idx, folder in enumerate(folder_paths):
        ...
        for subpath, subdir_list, subfile_list in os.walk(folder):
            ...
            if subdir_list:
                ...
                all_around_peak_data = pd.concat([all_around_peak_data, around_peak_data.assign(dpf=all_conditions[condition_idx][0],condition=all_conditions[condition_idx][4:])])
